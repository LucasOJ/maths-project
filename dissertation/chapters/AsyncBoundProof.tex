...
\begin{proof}
	...
	Note that in the final bound for $t_\text{half}$ we have eliminated all random quantities such as $\tau_i$, thus this bound can be calculated using only information about network, and holds w.h.p.
