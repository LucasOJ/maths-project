...
% TODO: MOTIVATION - why study this example?, last chapter, should measure the bound against adversarial cases, add to implicaions above

% TODO: Not static.

% MAYBE: Adversarial not "figting back" but one of the possibilites the bound has to account for
...
% TODO: adversarial Reaction vs part of the sample space here
