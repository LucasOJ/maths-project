...
Thus, the $\mathcal{O}(n \log n)$ bound given by Theorem $\ref{theorem:AsyncUpperBound}$ is larger by a factor of $n$ in scaling. % TODO: Justify more - bound is weak, doesn't give much information, less useful, motivates investigation into why the bound is weak in this case, and are there other cases where it is also weak?, can we tighten it?

\subsubsection{Adversarial Ring}
