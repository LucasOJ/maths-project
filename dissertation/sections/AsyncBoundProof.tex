...
In this section we define an algorithm for rumour spreading on a dynamic network, and prove a bound on the associated spreading time that holds with high probability. We then investigate how useful this bound is in practice by applying it to a selection of simple dynamic networks, and comparing the results with simulated spreading times. 
