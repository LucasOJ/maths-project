...
\begin{definition}\label{def:HkAB}
	...
	Let $V$ be a set of $n$ vertices, with $A \subset V$ an arbitrary subset satisfying $\frac{n}{4} \leq |A| \leq \frac{3n}{4}$. % TODO: Reconsile floors and ceilings on bounds, want that B_0 > 3n/4 
