...
In this section, we prove that the upper bound derived in Section \ref{section:AsyncUpperBound} is almost tight up to scaling in $n$, by constructing an example of a dynamic network given in \cite{asyncPaper}, where the spread time is close to the bound w.h.p.
